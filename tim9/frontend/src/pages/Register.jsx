      ...
      <div className="flex flex-col h-screen justify-center items-center">
        <div className="border w-[700px]  bg-white rounded-lg shadow-lg px-10 pt-10 pb-5 translate-y-20 relative">
          ...
          <div className="mt-5 flex border border-[#ff9666] rounded-lg">
            <Link className=" rounded-lg w-full text-center text-[#ff9666]  px-10 py-2">
              Sign in
            </Link>
            <Link className="border-[#ff9666] text-center text-white bg-[#ff9666] rounded-lg w-full  px-10 py-2">
              Sign up
            </Link>
          </div>
