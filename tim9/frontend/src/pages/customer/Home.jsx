      ...
      <div className="bg-[#ebe2b4] px-14 ">
        <div className="bg-[#ebe2b4] flex flex-col items-center relative h-screen">
          <div className="flex flex-col items-center z-10 mt-24">
            ...
            <p className="text-white text-7xl font-extrabold drop-shadow-lg">
              Paling Enak
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 ">
          <div>
            <p className="text-4xl font-medium">Tentang</p>
        ...
        <div className="h-screen">
          <p className="mb-4 font-bold text-4xl text-center">Menu</p>
